...
class DidPanModifier extends Modifier {
  element;
  threshold;
  axis;
  capture;
  ...
  static {
    n(this.prototype, "didTouchStart", [action]);
  }
  ...
  static {
    n(this.prototype, "documentPointerMove", [action]);
  }
  documentPointerUp(e) {
    if (this.dragging && this.pointerTypes.includes(e.pointerType)) {
  ...
  static {
    n(this.prototype, "documentPointerUp", [action]);
  }
  handlePointerMove(e) {
  ...
  static {
    n(this.prototype, "handlePointerMove", [action]);
  }
  handlePointerEnd(e) {
    if (this.dragging && this.currentTouches.has(e.pointerId)) {
      this.dragging = false;
  ...
  static {
    n(this.prototype, "handlePointerEnd", [action]);
  }
}
